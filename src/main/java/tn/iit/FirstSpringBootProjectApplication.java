...
public class FirstSpringBootProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * compteDaoSpringData.saveAndFlush(compte); Compte compte2 = new Compte(500,
		 * client); compteDaoSpringData.saveAndFlush(compte2); Compte compte3 = new
		 * Compte(500, client); compteDaoSpringData.saveAndFlush(compte3);
		 */
	...
	//	Client client = clientDaoSpringData.getById("057");
		...
		//List<Compte> comptes = client.getComptes() ; //compteDaoSpringData.findByClientCin("057");
